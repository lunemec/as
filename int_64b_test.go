...
func TestInt(t *testing.T) {
	...
	assertNoError(t, as.Int, int64(math.MinInt64))
	assertNoError(t, as.Int, int64(math.MaxInt64))

	assertNoError(t, as.Int, int(math.MinInt64))
	assertNoError(t, as.Int, int(math.MaxInt64))
	...
	assertNoError(t, as.Int, uint32(math.MaxUint32))

	assertNoError(t, as.Int, uint64(0))
	assertNoError(t, as.Int, uint64(math.MaxUint32))
	assertError(t, as.Int, uint64(math.MaxUint64))

	assertNoError(t, as.Int, uint(0))
	assertNoError(t, as.Int, uint(math.MaxUint32))
	assertError(t, as.Int, uint(math.MaxUint64))
}
